...
const KIND_CONFIG = {
  ...
  spreadsheet: {
    ...
    badgeClassName: 'bg-[#1a5c38] text-[#f5deb3] dark:bg-[#39ff14] dark:text-[#000000]',
  },
  video: {
    icon: FilmIcon,
    label: 'Video',
