const accountantConfig = {
  ...
  sections: {
    ...
    'ai-assistant': { title: 'AI Assistant', subtitle: 'Chat with Workers AI for finance summaries, notices, and professional drafting support.', panels: [{ title: 'AI Support', items: [{ text: 'Draft finance updates, reminder notices, and internal summaries.' }, { text: 'Keep one running chat for follow-up questions and revisions.' }, { text: 'The assistant never reconciles, approves, or edits finance records for you.' }] }] },
