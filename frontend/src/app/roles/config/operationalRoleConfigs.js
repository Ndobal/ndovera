const operationalRoleConfigs = {
  ...
  transport: {
    ...
    sections: {
      ...
      admissions: { title: 'Admissions Queue', subtitle: 'Review applicants that requested transport support before resumption.', panels: [{ title: 'Transport Intake', items: [{ text: 'Review route and pick-up area notes.' }, { text: 'Confirm transport demand before admission approval.' }, { text: 'Coordinate route planning with school leadership.' }] }] },
  ...
  hostel: {
    ...
    sections: {
      ...
      admissions: { title: 'Admissions Queue', subtitle: 'Review applicants that requested hostel accommodation.', panels: [{ title: 'Hostel Intake', items: [{ text: 'Check boarding requirement and room notes.' }, { text: 'Estimate bed demand before onboarding.' }, { text: 'Flag special welfare considerations early.' }] }] },
  ...
  clinic: {
    ...
    sections: {
      ...
      admissions: { title: 'Admissions Queue', subtitle: 'Review applicants with clinic or medical follow-up needs.', panels: [{ title: 'Clinic Intake', items: [{ text: 'Check allergies, conditions, and medical notes.' }, { text: 'Prepare follow-up care before resumption.' }, { text: 'Escalate any urgent health declarations.' }] }] },
  ...
  ict: {
    ...
    sections: {
      ...
      results: { title: 'Results Console', subtitle: 'Configure result templates and distribute uploaded PDFs.', panels: [{ title: 'Results Workflow', items: [{ text: 'Configure templates, grading, rating, and affective scales.' }, { text: 'Upload PDF results by term and session.' }, { text: 'Match files to students using display ID or email.' }] }] },
  ...
  classteacher: {
    ...
    sections: {
      ...
      results: { title: 'Results', subtitle: 'Manage all subjects, affective areas, and remarks for your class.', panels: [{ title: 'Class Result Duties', items: [{ text: 'Override or complete all subject CA entries for your class.' }, { text: 'Record attendance, affective areas, and final remarks.' }, { text: 'Submit completed class results for HoS approval.' }] }] },
