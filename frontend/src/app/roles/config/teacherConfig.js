const teacherConfig = {
  ...
  sections: {
    ...
    'ai-assistant': { title: 'AI Assistant', subtitle: 'Chat with Workers AI for lesson planning, communication drafts, and general teaching support.', panels: [{ title: 'AI Support', items: [{ text: 'Draft lesson starts, revision tasks, and parent communication.' }, { text: 'Ask follow-up questions in the same chat without losing context.' }, { text: 'Responses never claim to submit records or change data for you.' }] }] },
