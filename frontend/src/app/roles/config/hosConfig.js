const hosConfig = {
  ...
  sections: {
    ...
    'ai-assistant': { title: 'AI Assistant', subtitle: 'Chat with Workers AI for leadership drafts, planning, and staff support follow-ups.', panels: [{ title: 'AI Support', items: [{ text: 'Draft staff updates, meeting briefs, and leadership summaries.' }, { text: 'Ask follow-up questions in the same chat to keep context.' }, { text: 'The assistant does not approve workflows or change records for you.' }] }] },
