...
export default function HoSExams({ auth }) {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      <div className="rounded-3xl p-6 bg-[#b5e3f4] dark:bg-slate-900/30 border border-[#c9a96e]/40 dark:border-white/10 flex items-center justify-between gap-4">
        <div>
        ...
        <button
          ...
          className="bg-[#1a5c38] dark:bg-emerald-700 hover:bg-[#154a2e] dark:hover:bg-emerald-600 text-[#b5e3f4] font-bold dark:text-white px-5 py-2.5 rounded-2xl text-sm transition-colors whitespace-nowrap"
        >
          Create Exam
        </button>
      </div>
