  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      <div className="rounded-3xl p-6 bg-[#b5e3f4] dark:bg-slate-900/30 border border-[#c9a96e]/40 dark:border-white/10 flex items-start justify-between gap-4">
        ...
        <Link
          to="/register-school"
          className="shrink-0 bg-[#1a5c38] hover:bg-[#154a2e] text-[#b5e3f4] font-bold px-5 py-3 rounded-2xl text-sm transition-colors"
        >
          + Add School
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-3xl p-10 bg-[#b5e3f4] dark:bg-slate-900/30 border border-[#c9a96e]/40 dark:border-white/10 text-center">
          ...
          <Link
            to="/register-school"
            className="inline-block bg-[#1a5c38] hover:bg-[#154a2e] text-[#b5e3f4] font-bold px-6 py-3 rounded-2xl text-sm transition-colors"
          >
            + Add School
          </Link>
        </div>
          ...
          {schools.map((school) => (
            ...
            >
              ...
              <Link
                ...
                className="mt-auto bg-[#1a5c38] hover:bg-[#154a2e] text-[#b5e3f4] font-bold px-4 py-3 rounded-2xl text-center text-sm transition-colors"
              >
                Manage
              </Link>
            </div>
