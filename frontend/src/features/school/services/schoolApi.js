...
export const getMonnifyAccount = () => req('/api/tenants/monnify/account');
export const getMonnifyBanks = () => req('/api/tenants/monnify/banks');
export const createMonnifyVirtualAccount = (data) => req('/api/tenants/monnify/reserved-account', { method: 'POST', body: data });
