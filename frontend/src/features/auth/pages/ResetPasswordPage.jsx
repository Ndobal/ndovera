...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#cfecf7_0%,#ffffff_52%,#ecfdf5_100%)] px-4 pt-[calc(2rem+var(--safe-top))] pb-[calc(2rem+var(--safe-bottom))] sm:px-6 lg:px-8">
