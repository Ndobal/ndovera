  ...
  return (
    <div className="glass-surface rounded-3xl p-5 space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <input type="password" placeholder="Current password" value={current} onChange={e => setCurrent(e.target.value)} className="p-2 wheat-input dark:bg-slate-900/40 dark:text-slate-100 rounded-xl" />
        <input type="password" placeholder="New password" value={next} onChange={e => setNext(e.target.value)} className="p-2 wheat-input dark:bg-slate-900/40 dark:text-slate-100 rounded-xl" />
      </div>
