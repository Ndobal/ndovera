    ...
    <section className="rounded-3xl border border-[#c9a96e]/40 bg-[#f5deb3] p-5">
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {teachers.map((item, i) => (
            <div key={item.id || item.name || i} className="rounded-2xl border border-[#c9a96e]/30 bg-[#f0d090] p-4 flex flex-wrap justify-between gap-3">
              <div>
              ...
              <span className="rounded-full bg-[#800020] px-3 py-1 text-[10px] font-bold uppercase text-[#f5deb3] h-fit self-center">
