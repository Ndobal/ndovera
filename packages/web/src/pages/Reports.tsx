    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button className="bg-white/5 border border-white/5 text-zinc-400 px-4 py-2 rounded-lg text-[11px] font-bold uppercase tracking-wider flex items-center gap-2">
            <Filter size={14} /> Customize
          </button>
          <button className="bg-emerald-600 text-white px-4 py-2 rounded-lg text-[11px] font-bold uppercase tracking-wider flex items-center gap-2">
        ...
        {reportTypes.map((report, i) => (
          <div key={i} className="card-compact group">
            <div className="flex items-start justify-between mb-6">
              ...
              <button className="p-2 bg-white/5 hover:bg-emerald-600 hover:text-white rounded-xl transition-all">
                <Download size={16} />
              </button>
            </div>
